...
# ip_changer = TorIpChanger(reuse_threshold=10, tor_password="tor", new_ip_max_attempts=20, post_new_ip_sleep=10)
...
#         # request.meta["proxy"] = "172.18.0.3:8080"
